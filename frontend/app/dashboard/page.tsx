...
import { Plus, Search, Star, Copy, MoreHorizontal, Pencil, Trash2, Eye, EyeOff } from "lucide-react"
...
export default function DashboardPage() {
    ...
    const handleAdd = (data: { website: string; username: string; password: string; notes: string }) => {
